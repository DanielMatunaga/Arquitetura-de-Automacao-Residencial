...
float f_y0 = 0, f_y1 = 0;
float f_kp = 10, f_ki = 100, f_kd = 0;
float f_T = 0.01;

#define SHIFT (256)
int32_t i_e0 = 0, i_e1 = 0, i_e2 = 0;
int32_t i_y0 = 0, i_y1 = 0;

#define MAX_SAT 1023
#define MIN_SAT 0

int32_t i_k1;// = (f_kp + f_ki * f_T + f_kd / f_T) * SHIFT;
  int32_t i_k2;// = -((f_kp + 2 * f_kd / f_T) * SHIFT);
  int32_t i_k3;// = (f_kd / f_T) * SHIFT;
...
i_k1 = (f_kp + f_ki * f_T + f_kd / f_T) * SHIFT;
i_k2 = -((f_kp + 2 * f_kd / f_T) * SHIFT);
i_k3 = (f_kd / f_T) * SHIFT;
}
